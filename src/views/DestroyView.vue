<template>
    <section class="backup scroller">
        ...
        <section class="panel" v-if="!verified">
            ...
            <cin :placeholder="locale(langKeys.PLACEHOLDER_Password)" type="password"
                 v-on:changed="changed => bind(changed, 'currentPassword')" :key="1"></cin>
            <btn v-on:clicked="verifyCurrentPassword" :text="locale(langKeys.PLACEHOLDER_ConfirmPassword)"
                 :margined="true"></btn>
        </section>
        ...
        <section class="panel" v-else>
            ...
            <btn v-on:clicked="destroy_gscatter" :text="locale(langKeys.BUTTON_DestroyScatter)" is-red="true"
                 :margined="true"></btn>
        </section>
