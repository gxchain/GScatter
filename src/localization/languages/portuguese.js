...
export default {
    ...
    [KEYS.BUTTON_DestroyScatter]:'Remover GXC Wallet',
    [KEYS.BUTTON_CreateNewScatter]:'Criar Novo GXC Wallet',
    [KEYS.BUTTON_LoadFromBackup]:'Carregar Do Backup',
    [KEYS.BUTTON_Unlock]:'Desbloquear',
    [KEYS.BUTTON_ExportScatter]:'Exportar GXC Wallet',
    ...
    [KEYS.HISTORIES_Description]:`
        Depois de tê-los, você poderá ver uma lista de todos os eventos que passam pelo seu GXC Wallet.
        O que você não verá é eventos que ocorreram em suas contas fora do GXC Wallet.
     `,
    [KEYS.HISTORIES_Note]:`
        Nota: Exportar seus dados do GXC Wallet através da opção de backup no painel de configurações não salva esses eventos.
        Quando você importar seus dados do GXC Wallet novamente, seus históricos ficarão vazios. Se você gostaria de exportar seus históricos
    ...
    [KEYS.BACKUP_Description]:`
        Exportar seu GXC Wallet permite que você o importe em outros dispositivos. O arquivo ainda será criptografado quando for
    ...
    [KEYS.DESTROY_Header]:`Destruindo o GXC Wallet`,
    [KEYS.DESTROY_Description]:`
        Você está prestes a destruir todo o seu chaveiro GXC Wallet. A única maneira de recuperar exatamente esse GXC Wallet será
        importando um JSON exportado pelo GXC Wallet anteriormente. Você não poderá reivindicar suas identidades de outra forma.
        Assegure-se de que você tenha exportado seu GXC Wallet do painel de configurações de backup antes de continuar
    `,
    ...
    [KEYS.LOCK_Description]:`
        O Bloqueio Automático lida com o bloqueio do GXC Wallet para que você não precise
        se lembrar de bloquear seu GXC Wallet quando você se afastar do computador.
    `,
    ...
    [KEYS.MNEMONIC_Note]:`
        ...
        GXC Wallet e descriptografar suas informações privadas se você esquecer sua senha.
    `,
    ...
    [KEYS.ALERT_NoAccountsFound]:[
        ...
        `Nenhuma conta foi encontrada conectada a essa chave privada.
         ...
         GXC Wallet, você precisará criar uma conta para a chave
         antes de importá-la.`
    ],
    ...
    [KEYS.ALERT_RemovingEndorsedNetwork]:[
        ...
        `Você não pode remover a rede endossada do GXC Wallet. Usamos essa rede para hospedar nossos contratos.`
    ],
    ...
    [KEYS.REQUEST_AddNetwork]:[
        /*{DOMAIN}*/ 'quer adicionar sua rede ao seu GXC Wallet.',

        'Alguns aplicativos usam suas próprias redes.',

        `Isso não dá ao aplicativo qualquer acesso ao seu GXC Wallet.
    ...
    [KEYS.REQUEST_ScatterIsLocked]:[
        `Seu GXC Wallet está bloqueado!`,

        `Antes de fazer qualquer coisa com o seu GXC Wallet, você deve desbloqueá-lo.`,
        ...
        `Se você ver um prompt/popup que solicitando sua senha, é um site malicioso tentando obter sua senha.
         Somente desbloqueie o GXC Wallet a partir do popup da extensão, clicando no ícone na bandeja do seu navegador.`
    ],
    [KEYS.REQUEST_UpdateVersion]:[
        `Seu GXC Wallet está desatualizado!`,

        /*{DOMAIN}*/ `está exigindo que você tenha uma versão do GXC Wallet mais recente que a instalada.`,
        ...
        `Por favor, note que deixamos a verificação de versão a cargo das próprias aplicações. Eles podem, maliciosamente
         tentar fazer você baixar algo. Certifique-se de sempre baixar o GXC Wallet do local apropriado.`
    ],
